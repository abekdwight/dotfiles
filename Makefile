...
ALL_TARGETS += $(MISE_TARGETS)
ALL_CLEAN_TARGETS += $(MISE_CLEAN_TARGETS)
...
ALL_TARGETS += $(WARP_TARGETS)
ALL_CLEAN_TARGETS += $(WARP_CLEAN_TARGETS)

# zed
ZED_TARGETS +=
ZED_CLEAN_TARGETS +=

ALL_TARGETS += $(ZED_TARGETS)
ALL_CLEAN_TARGETS += $(ZED_CLEAN_TARGETS)
